...
//http://www.cnblogs.com/moqing/archive/2016/07/13/5665126.html 过目不忘js正则表达式
...
var str = '2013-6-7';
var re = /(\d+)(-)/g;
str = str.replace(re,function($0,$1,$2,index,me){//如果
